const y = "required", z = "fn", A = "argv", B = "ref", C = "authSchemes", D = "signingRegion";
const a = true, b = "isSet", c = "booleanEquals", d = "error", e = "endpoint", f = "tree", g = "PartitionResult", h = "stringEquals", i = "sigv4", j = { [y]: true, "default": false, "type": "boolean" }, k = { [y]: false, "type": "string" }, l = { [B]: "Endpoint" }, m = { [z]: c, [A]: [{ [B]: "UseFIPS" }, true] }, n = { [z]: c, [A]: [{ [B]: "UseDualStack" }, true] }, o = {}, p = { [z]: "getAttr", [A]: [{ [B]: g }, "name"] }, q = { [z]: c, [A]: [{ [B]: "UseFIPS" }, false] }, r = { [z]: c, [A]: [{ [B]: "UseDualStack" }, false] }, s = { [z]: h, [A]: [p, "aws-eusc"] }, t = { "url": "https://ce.eusc-de-east-1.api.amazonwebservices.eu", "properties": { [C]: [{ "name": i, [D]: "eusc-de-east-1" }] }, "headers": {} }, u = { [z]: "getAttr", [A]: [{ [B]: g }, "supportsFIPS"] }, v = { [z]: c, [A]: [true, { [z]: "getAttr", [A]: [{ [B]: g }, "supportsDualStack"] }] }, w = { [C]: [{ "name": i, [D]: "{PartitionResult#implicitGlobalRegion}" }] }, x = [{ [B]: "Region" }];
